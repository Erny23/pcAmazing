    ...
    return (
        <>
                    ...
                    <div className="container mx-auto max-w-5xl px-4 pt-5">
                        ...
                        <div className="flex flex-row items-center justify-between py-5">
                            ...
                            <form className="flex w-1/2 flex-row items-center" action="">
                                ...
                                <IoSearch className="size-12 cursor-pointer bg-teal-400 p-2 text-white" />
                            </form>
                            <div className="flex cursor-pointer flex-row items-center gap-2 text-zinc-400">
                                <FaCartShopping className="size-12 h-full bg-teal-400 p-2 text-white" />
            ...
            <div id="navLinks4" className="bg-zinc-700">
                <div className="container mx-auto grid max-w-7xl grid-cols-7 justify-start gap-3 divide-x-2 px-4 py-5 text-center text-white">
                    <div>Home</div>
                    <div>About Us</div>
